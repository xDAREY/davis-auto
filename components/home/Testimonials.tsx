export function Testimonials() {
  const testimonials = [
    {
      id: '1',
      text: 'Dameon made the whole process incredibly easy. I told him what I was looking for, he found it, handled the negotiation, and I drove off within days. No dealership stress — just results.',
      author: 'Marcus T.',
    ...
    {
      id: '2',
      text: 'Davis House completely changed how I think about buying a car. Upfront about everything, found me a clean BMW at a fair price, and kept me informed the whole way through.',
      author: 'Janelle R.',
    ...
    {
      id: '3',
      text: 'Bought an Audi through Davis House — spotless condition, full history, exactly as described. Dameon takes pride in what he does. I\'ve already referred two colleagues.',
      author: 'Kevin O.',
